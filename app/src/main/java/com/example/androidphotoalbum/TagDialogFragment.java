...
public class TagDialogFragment extends DialogFragment
{
	...
	public Dialog onCreateDialog(Bundle savedInstanceState)
	{
		...
		ccontrol = Controller.getInstance(getActivity().getApplicationContext());
		int titleId = 0;
		int buttonId = 0;
							...
							switch (mode)
							{
								case 1 :
									...
									String tagValue = TagDialogFragment.this.value.getText()
											.toString();
									if (ccontrol.addTagToPhoto(album, filename, tagType, tagValue))
									{
								...
								case 2 :
									...
									if (ccontrol.renameAlbum(TagDialogFragment.this.album, val))
									{
